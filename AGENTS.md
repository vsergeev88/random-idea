# Core Rules
- Always read and follow relevant skills from .agents/skills/ before searching the web. Use WebSearch only when skills don't provide sufficient information.
