...
function ColourfulText({
  ...
  useImperativeHandle(ref as any, () => localRef.current as HTMLSpanElement);
    ...
    <span data-slot="colourful-text" ref={localRef} {...(props as any)}>
      {characters.map((char, index) => (
        <motion.span
          ...
          className="inline-block whitespace-pre font-sans tracking-tight will-change-filter will-change-opacity will-change-transform"
          initial={{ y: 0 }}
